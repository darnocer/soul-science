...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('data/content')) fs.mkdirSync('data/content', { recursive: true })
    const filePath = `data/content/${fileName ? fileName : 'untitled'}.${answers.extension ? answers.extension : 'md'}`
