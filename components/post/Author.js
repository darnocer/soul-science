  ...
  if (typeof author === 'string') {
    ...
    return (
      <div className='flex items-center space-x-3'>
        ...
        <span className='text-tertiary-800 dark:text-tertiary-800 text-xs font-semibold'>{authorData.name}</span>
      </div>
    )
  }
  ...
  if (typeof author === 'object' && author.name) {
    return (
      <div className='flex items-center space-x-3'>
        ...
        <span className='text-tertiary-800 dark:text-tertiary-800 text-xs font-semibold'>{author.name}</span>
      </div>
    )
  }
