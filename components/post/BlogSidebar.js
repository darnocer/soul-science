...
const BlogSidebar = ({ author, tags, next, prev }) => {
  return (
    <aside className='mt-6 rounded-md p-4 dark:bg-black xl:sticky xl:top-24 xl:col-start-1 xl:row-span-2 xl:max-h-max'>
      {author && (
        <div className='pb-2 pt-2 xl:border-b xl:border-gray-200 xl:dark:border-gray-700'>
          <span className='text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400'>Author:</span>
      ...
      <div className='divide-gray-200 text-sm font-medium leading-5 dark:divide-gray-700 xl:divide-y'>
        ...
        {(next || prev) && (
          <div className='flex justify-between py-4 xl:block xl:space-y-8 xl:py-8'>
            {prev && (
              <div>
                <span className='text-xs uppercase tracking-wide text-gray-500 dark:text-gray-400'>Next Article:</span>
